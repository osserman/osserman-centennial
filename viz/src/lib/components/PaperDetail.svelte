	...
	>
		...
		{#if node.topic}
			<div class="topic-row">
				...
				<span
					class="info-icon"
					title="OpenAlex's automated topic classification is not always accurate, especially for older or interdisciplinary papers — treat this as a hint, not ground truth."
					>ⓘ</span
				>
			</div>
		{/if}
