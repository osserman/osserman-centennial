	...
	>
		...
		{#if node.topic}
			<div class="topic-row">
				...
				<span class="info-icon" tabindex="0" role="button" aria-label="About OpenAlex topics">
					ⓘ
					<span class="info-tooltip" role="tooltip">
						OpenAlex's automated topic classification is not always accurate, especially for
						older or interdisciplinary papers — treat this as a hint, not ground truth.
					</span>
				</span>
			</div>
		{/if}
